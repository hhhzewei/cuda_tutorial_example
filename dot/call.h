...
void call_dot_warp_shuffle_xor_v1(unsigned N, float *dev_a, float *dev_b, float *dev_ret, float *ret);

void call_dot_warp_shuffle_xor_v2(unsigned N, const float *dev_a, const float *dev_b, float *dev_ret,
                                  float *ret);
